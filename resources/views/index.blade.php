...
<body>
    ...
    <header id="header" class="fixed-top d-flex align-items-center">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="logo">
                <h1><a href="index.html">SIM ANTRIAN</a></h1>
                    ...
                    <div class="row">
                        <div class="col-lg-8 text-center text-lg-start">
                            ...
                            <p data-aos="fade-right" data-aos-delay="200" data-aos-offset="-500"><a href="#"
                                    class="btn btn-outline-white">Antri sekarang !</a></p>
                        </div>
                        <div class="col-lg-4 iphone-wrap">
                            <img src="assets/img/gambar.png" alt="Image" class="phone-1" data-aos="fade-right">
                            <img src="assets/img/gambar.png" alt="Image" class="phone-2" data-aos="fade-right"
                                data-aos-delay="200">
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="review text-center">
                                            ...
                                            <blockquote>
                                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eius ea
                                                    ...
                                                    aperiam dolore nam optio dolorem facilis itaque voluptatum
                                                    recusandae deleniti minus animi,
